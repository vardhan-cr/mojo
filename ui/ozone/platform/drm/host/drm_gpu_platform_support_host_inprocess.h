...
class DrmGpuPlatformSupportHostInprocess : public DrmGpuPlatformSupportHostDelegate {
 public:
  DrmGpuPlatformSupportHostInprocess(DrmGpuPlatformSupportHost* platform_support);
